from ophyd import ProsilicaDetector, ProsilicaDetectorCam, ROIPlugin, ImagePlugin, StatsPluginV33, TransformPlugin, ROIStatPlugin, CamBase
...
class StandardProsilicaCam(ProsilicaCamBase):
    def __init__(self, *args, **kwargs):
        ...
        self._default_plugin_graph = {self.cam: self.roistat1} # ask tom if this should be reversed
